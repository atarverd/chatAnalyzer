...
export function AnalysisOptionsScreen({
  ...
  const questionCardWidth =
    cardsPerRow === 1 ? contentWidth : (contentWidth - questionGridGap) / 2;
                ...
                return (
                  ...
                  >
                    <LinearGradient
                      colors={
                        isSelected
                          ? [colors.blue22, colors.blue44, colors.blue14]
                          : [colors.white02, colors.white02]
                      }
                      start={{ x: 0, y: 0 }}
                      end={{ x: 0, y: 1 }}
                    ...
                    >
                      <LinearGradient
                        colors={[colors.backgroundCard, colors.backgroundCard]}
                      ...
                      >
                        <View style={styles.questionIconWrapper}>
                          <ExpoImage
                            ...
                            contentFit='contain'
                            tintColor={isSelected ? colors.blue : undefined}
                          />
                        </View>
                        <Text
                          style={[
